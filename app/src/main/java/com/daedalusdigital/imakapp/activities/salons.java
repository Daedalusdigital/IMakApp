...
import com.daedalusdigital.imakapp.cards.SliderAdapter;
import com.daedalusdigital.imakapp.utils.DecodeBitmapTask;
...
public class salons extends AppCompatActivity {
    ...
    private void onActiveCardChange(int pos) {
        ...
        clockSwitcher.setInAnimation(salons.this, animV[0]);
        clockSwitcher.setOutAnimation(salons.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(salons.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(salons.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(salons.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(salons.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(salons.this, sharedView, "shared");
